...
if($_GET){
	...
	if (!$user_id && $_GET['action'] != "add"){
		echo("<div class='error'>ERROR: please enter user ID as number</div>");
	}
	...
	if(!empty($_POST['username'])){
		...
		echo("<div class='error'>ERROR: Please enter username as string!</div>");
		$username = NULL;
		$error = true;
	}
	...
	if(!empty($_POST['password'])){
		...
		echo("<div class='error'>ERROR: Please enter password as string!</div>");
		$password = NULL;
		$error = true;
	}
	...
	if(!empty($_POST['bio'])){
		...
		echo("<div class='error'>ERROR: Please enter biography as string!</div>");
		$bio = NULL;
		$error = true;
	}
	...
	if(!empty($_POST['first_name']) && is_string($_POST['first_name'])){
		...
		echo("<div class='error'>ERROR: Please enter first name as string!</div>");
		$first_name = NULL;
		$error = true;
	}
	...
	if(!empty($_POST['last_name']) && is_string($_POST['last_name'])){
		...
		echo("<div class='error'>ERROR: Please enter last name as string!</div>");
		$last_name = NULL;
		$error = true;
	}
